...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String result=personalityType+"  "+dateFormat.format(testTime);

        dbHelper=new DbHelper(ResultActivity.this);
    ...
    public void tappedSaveResults(View view) {
        Intent intent = new Intent(ResultActivity.this,viewResultsActivity.class);
